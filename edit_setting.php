...
$qq = "SELECT * FROM tb_room WHERE id= '$id' ";
$wwq = mysqli_query($conn, $qq);
$rows = mysqli_fetch_array($wwq);

?>
         <form action="update-setting.php" method = "post" >
<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $rows["id"]; ?>" required="required">
         ...
         <div class="col-sm-3">
            ...
            <div class="col-sm-4">
 <input type="text" class="form-control" id="name" name="name" value="<?php echo $rows["name"]; ?>" required="required">
...
<div class="col-md-1 col-lg-2" >
                                <button class="form-control btn btn-danger" type="button" onclick="parent.location.href='setting.php'">ยกเลิก</button>
                            </div>
        </div>
            </form>
            </div>
