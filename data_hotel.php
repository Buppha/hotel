...
<nav class="w3-sidebar w3-collapse w3-white w3-animate-left" style="z-index:3;width:300px;" id="mySidebar"><br>
  ...
  <div class="w3-bar-block">
    ...
    <a href="#" class="w3-bar-item w3-button w3-padding w3-blue"><i class='fas fa-building'></i>  ข้อมูลโรงแรม</a>
...
$q = " SELECT * FROM tb_hotel WHERE hotel_id = '$hotel_id'";
...
while ($row = mysqli_fetch_array($qmany)) {?>
              ...
              <div class="row">
                <div class="column">
                  <div class="card">
                    <form action="data_hotel_update.php" method = "post" >
                      <div class="row">
                          <div class="col-sm-3">
                            ชื่อโรงแรม :
                          </div>
                          <div class="col-sm-4">
                            <input type="text" class="form-control" id="name" name="name" value = "<?php echo $row['hotel_name'] ?>" required="required">
                      ...
                      <div class="row">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" id="address" name="address" value = "<?php echo $row['address'] ?>" required="required">
                          </div>
                      </div>
                      <br>
                      <div class="row">
                          ...
                          <div class="col-sm-4">
                            <input type="text" class="form-control" id="token" name="token" value = "<?php echo $row['BK_token'] ?>" required="required">
                          </div>
                      </div>
                      <br>
                      ...
                      <div class="row">
                          <div class="col-sm-3">
                          <center><img src="<?php echo $objResult['img'] ?>" style="width:150px"></center>
                          <input type="hidden" id="pic" name="pic" value = "<?php echo $objResult['img'] ?>" >
