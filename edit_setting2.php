...
$qq = "SELECT * FROM tb_typeroom WHERE typeroom_id = '$id' ";
  $wwq = mysqli_query($conn,$qq);
  $rows = mysqli_fetch_array($wwq);


 ?>

         <form action="update-setting2.php" method = "post" >
<input type="hidden" class="form-control" id="id" name="id" value="<?php echo $rows["typeroom_id"];?>" required="required">
 ...
 <div class="row">
         <div class="col-sm-3">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="bed" name="bed" required="required" value="<?php echo $rows["type_bed"];?>">
            </div>
        </div>
        <br>
         ...
         <div class="col-sm-3">
            ...
            <div class="col-sm-4">
                <input type="text" class="form-control" id="price" name="price" required="required" value="<?php echo $rows["price"];?>">
            </div>
        </div>
        <br>
        <div class="row">
...
<div class="col-md-1 col-lg-2" >
                                <button class="form-control btn btn-danger" type="button" onclick="parent.location.href='setting2.php'">ยกเลิก</button>
                            </div>
        </div>
            </form>
            </div>
