...
<div class="w3-main" style="margin-left:320px;margin-top:43px;">
  ...
  <center>
		...
		<a href="hotel.php" class="btn" role="button">ทั้งหมด</a>
		<a href="#" class="btn btn-info" role="button">วันนี้</a>
    ...
    <table role="table">
      ...
      <tbody role="rowgroup">
        ...
        $hotel_id = $_SESSION["name_hotel"];
            ...
            AND tb_booking.date_come = curdate()
	        ORDER BY `booking_id`";
